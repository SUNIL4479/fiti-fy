...
import { Award, Flame, Zap, Trophy, ShieldCheck, Star, Users, CheckCircle2 } from "lucide-react";
...
export const LeaderboardAndBadges: React.FC<LeaderboardAndBadgesProps> = ({ user, badges }) => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8 text-white">
      <div>
        <h1 className="text-3xl font-extrabold text-white">Gamification & Achievements</h1>
        <p className="text-slate-300 text-sm">Level up, unlock trophies, and compete on the FitiFy Leaderboard.</p>
      </div>
      ...
      <div className="p-6 rounded-[24px] bg-[#0a0a0a] border border-[#222222] flex flex-col sm:flex-row sm:items-center justify-between gap-6 shadow-2xl">
        <div className="space-y-2">
          ...
          <h2 className="text-2xl font-extrabold text-white">Keep the Streak Alive!</h2>
          <p className="text-xs text-slate-400">Complete 1 workout daily to double your XP earnings.</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-7 space-y-4">
          <h3 className="text-xl font-bold text-white flex items-center gap-2">
            ...
            <span>Achievement Trophies ({badges.filter((b) => b.unlocked).length}/{badges.length})</span>
          </h3>
              ...
              <div
                ...
                className={`p-4 rounded-2xl border transition-all ${
                  badge.unlocked
                    ...
                    : "bg-[#050505] border-[#222222] opacity-60"
                }`}
              >
                <div className="flex items-start gap-3">
                  ...
                  <div className="space-y-1">
                    <div className="text-sm font-bold text-white flex items-center gap-2">
                      ...
                      {badge.unlocked && <CheckCircle2 className="w-4 h-4 text-[#c6ff00]" />}
                    </div>
